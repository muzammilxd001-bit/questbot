...
export class ClientQuest extends Client {
        ...
        public onQuestComplete?: (quest: Quest) => void | Promise<void>;
        ...
        emitQuestCompleted(questId: string) {
                if (this.onQuestComplete && this.questManager) {
                        const quest = this.questManager.get(questId);
                        if (quest) {
                                Promise.resolve(this.onQuestComplete(quest)).catch(() => {});
                        }
                }
